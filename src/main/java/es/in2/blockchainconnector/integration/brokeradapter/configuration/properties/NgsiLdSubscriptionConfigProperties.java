package es.in2.blockchainconnector.integration.brokeradapter.configuration.properties;
...
public record NgsiLdSubscriptionConfigProperties(String notificationEndpoint, String subscriptionType, String idPrefix, List<String> entityTypes) {
